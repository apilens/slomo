---
title: "Slomo Environment Variables — SLOMO_* Override Reference"
sidebarTitle: "Environment Variables"
description: "All SLOMO_* environment variables: what each one overrides in config.toml, how boolean values are parsed, and common one-off usage recipes."
icon: "terminal"
---
