---
title: "config.toml — Slomo Recorder Configuration Reference"
sidebarTitle: "config.toml"
description: "Complete reference for .slomo/config.toml: recording limits, storage retention, redaction rules, and every hook option with its default value."
icon: "sliders"
---
