---
title: "doctor"
description: "Heuristic root-cause diagnosis for an issue."
icon: "stethoscope"
---
...
The doctor walks the recorded timeline backwards from the crash and applies heuristics to produce a structured diagnosis:
