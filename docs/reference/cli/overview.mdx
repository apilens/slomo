---
title: "CLI overview"
description: "The slomo command: every subcommand at a glance, plus the interactive shell."
icon: "terminal"
---
...
Running `slomo` with no command opens an interactive shell with **history and tab completion** — the same commands, without retyping the prefix:
