---
title: "Slomo CLI: sessions, session show, inspect, and delete"
sidebarTitle: "Sessions"
description: "List recorded sessions, view per-session metadata and span trees, and delete individual recordings with the slomo session commands."
icon: "list"
---
