---
title: "Slomo CLI: vars, http, and sql — Typed Data Views"
sidebarTitle: "Data Views"
description: "Filter a session or issue to just variable snapshots, HTTP request/response pairs, or SQL queries and results with slomo vars, http, and sql."
icon: "table"
---
