---
title: "Slomo CLI: stats and prune — Storage and Retention"
sidebarTitle: "Stats & Prune"
description: "Check session counts, event totals, issue categories, and storage usage with slomo stats, or trim old sessions to a retention limit with slomo prune."
icon: "broom"
---
