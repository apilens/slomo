---
title: "Slomo Python API Reference — Flight Recorder Functions"
description: "Complete public API reference for slomo's seven importable functions: enable, disable, track, snapshot, event, install_hooks, and flush."
icon: "python"
---
