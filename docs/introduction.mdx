---
title: "Slomo — Black Box Flight Recorder for Python Apps"
sidebarTitle: "Introduction"
description: "Slomo captures every function call, crash, SQL query, and HTTP request locally — replay and diagnose bugs from your terminal without a server or account."
---
