---
title: "The Slomo investigation workflow: triage to resolve"
sidebarTitle: "Investigation Workflow"
description: "The day-to-day debug loop: list grouped crashes, diagnose root causes with slomo doctor, replay the exact execution, then mark issues resolved."
