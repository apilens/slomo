---
title: "Workers and Async — Threads, asyncio, Multi-Process Apps"
sidebarTitle: "Workers and Async"
description: "Record background-thread crashes, asyncio failures, and multi-process apps. Forked children get their own session, and issues aggregate across all workers."
icon: "arrows-spin"
---
