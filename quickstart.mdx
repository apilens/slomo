---
title: "Get Started with Slomo in 5 Minutes"
sidebarTitle: "Quickstart"
description: "Install Slomo, add two lines to your Python app, run it, and explore your first crash recording with the terminal UI."
---
...
<Steps>
  ...
  <Step title="Run your app and trigger a crash">
    ...
    When the script exits (even after a crash), Slomo writes the full session recording to `.slomo/` in the current directory. The directory is created automatically on the first run — you don't need to do anything to set it up.
